...
Revision ID: 6a47da610b5e
Revises: 
Create Date: 2021-12-03 19:56:11.182270
...
def upgrade():
    ...
    sa.Column('customer_id', sa.Boolean(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('value', sa.Float(precision=10, asdecimal=2), nullable=True),
    sa.Column('mode', sa.String(length=15), nullable=True),
